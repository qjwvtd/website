...
var close = document.getElementsByClassName('ui-nav-close')[0];
...
var message = {
    ...
    success:function(text){
        var delay = this.__delay;//默认延迟3秒关闭
        var successTemplate = '<a class="ui-message-body ui-message-success">' +
...
/**********分界线**********/
//加入我们页页跳转
function joinUsPageTab(num) {
    var arr = ["environment.html","companyCulture.html","jobs.html"];
