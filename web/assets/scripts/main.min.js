...
"use strict";function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}!function(t,o){"function"==typeof define&&define.amd?define(["jquery"],function(e){return o(e,t,t.document)}):"object"===("undefined"==typeof module?"undefined":_typeof(module))&&module.exports?module.exports=o(require("jquery"),t,t.document):o(jQuery,t,t.document)}("undefined"!=typeof window?window:void 0,function(r,i,s,t){var u,l,h,f,d,p=[],g=[],m=[],y=[],v=0,c=0,w=1,S=!1,b=r(i),H=b.scrollTop(),E=!1,M=!1,x=!1,T=!1,D=[],I=(new Date).getTime(),a=!0,N=!1,k=0,L="onwheel"in s?"wheel":s.onmousewheel!==t?"mousewheel":"DOMMouseScroll",z={section:".section",sectionName:"section-name",interstitialSection:"",easing:"easeOutExpo",scrollSpeed:1100,offset:0,scrollbars:!0,target:"html,body",standardScrollElements:!1,setHeights:!0,overflowScroll:!0,updateHash:!0,touchScroll:!0,before:function(){},after:function(){},afterResize:function(){},afterRender:function(){}};function O(e,t,o,n){if(c===e&&(o=!1),!0===T)return!0;if(g[e]){if(E=!1,o&&z.before(e,m),w=1,k=p[e],!1===a&&e<c&&!1===n&&y[e]&&(w=parseInt(m[e].outerHeight()/b.height()),k=parseInt(p[e])+(m[e].outerHeight()-b.height())),z.updateHash&&z.sectionName&&(!0!==a||0!==e))if(history.pushState)try{history.replaceState(null,null,g[e])}catch(e){i.console&&console.warn("Scrollify warning: Page must be hosted to manipulate the hash value.")}else i.location.hash=g[e];if(a&&(z.afterRender(),a=!1),c=e,t)r(z.target).stop().scrollTop(k),o&&z.after(e,m);else{if(M=!0,r().velocity?r(z.target).stop().velocity("scroll",{duration:z.scrollSpeed,easing:z.easing,offset:k,mobileHA:!1}):r(z.target).stop().animate({scrollTop:k},z.scrollSpeed,z.easing),i.location.hash.length&&z.sectionName&&i.console)try{r(i.location.hash).length&&console.warn("Scrollify warning: ID matches hash value - this will cause the page to anchor.")}catch(e){}r(z.target).promise().done(function(){a=M=!1,o&&z.after(e,m)})}}}function R(r){function e(e){for(var t=0,o=r.slice(Math.max(r.length-e,1)),n=0;n<o.length;n++)t+=o[n];return Math.ceil(t/e)}var t=e(10);return e(70)<=t}var e=function(e){function t(e){r().velocity?r(z.target).stop().velocity("scroll",{duration:z.scrollSpeed,easing:z.easing,offset:e,mobileHA:!1}):r(z.target).stop().animate({scrollTop:e},z.scrollSpeed,z.easing)}function o(e){e&&(H=b.scrollTop());var t=z.section;y=[],z.interstitialSection.length&&(t+=","+z.interstitialSection),!1===z.scrollbars&&(z.overflowScroll=!1),r(t).each(function(e){var t=r(this);z.setHeights?t.is(z.interstitialSection)?y[e]=!1:t.css("height","auto").outerHeight()<b.height()||"hidden"===t.css("overflow")?(t.css({height:b.height()}),y[e]=!1):(t.css({height:t.height()}),z.overflowScroll?y[e]=!0:y[e]=!1):t.outerHeight()<b.height()||!1===z.overflowScroll?y[e]=!1:y[e]=!0}),e&&b.scrollTop(H)}function n(e,t){var o=z.section;z.interstitialSection.length&&(o+=","+z.interstitialSection),p=[],g=[],m=[],r(o).each(function(e){var t=r(this);p[e]=0<e?parseInt(t.offset().top)+z.offset:parseInt(t.offset().top),z.sectionName&&t.data(z.sectionName)?g[e]="#"+t.data(z.sectionName).toString().replace(/ /g,"-"):!1===t.is(z.interstitialSection)?g[e]="#"+(e+1):(g[e]="#",e===r(o).length-1&&1<e&&(p[e]=p[e-1]+(parseInt(r(r(o)[e-1]).outerHeight())-parseInt(r(i).height()))+parseInt(t.outerHeight()))),m[e]=t;try{r(g[e]).length&&i.console&&console.warn("Scrollify warning: Section names can't match IDs - this will cause the browser to anchor.")}catch(e){}i.location.hash===g[e]&&(v=e,S=!0)}),!0===e&&O(v,!1,!1,!1)}function c(){return!y[v]||!((H=b.scrollTop())>parseInt(p[v]))}function a(){return!y[v]||!((H=b.scrollTop())<parseInt(p[v])+(m[v].outerHeight()-b.height())-28)}N=!0,r.easing.easeOutExpo=function(e,t,o,n,r){return t==r?o+n:n*(1-Math.pow(2,-10*t/r))+o},f={touches:{touchstart:{y:-1,x:-1},touchmove:{y:-1,x:-1},touchend:!(h={handleMousedown:function(){if(!0===T)return!0;x=E=!1},handleMouseup:function(){if(!0===T)return!0;E=!0,x&&h.calculateNearest(!1,!0)},handleScroll:function(){if(!0===T)return!0;u&&clearTimeout(u),u=setTimeout(function(){if(!(x=!0)===E)return!1;E=!1,h.calculateNearest(!1,!0)},200)},calculateNearest:function(e,t){H=b.scrollTop();for(var o,n=1,r=p.length,i=0,s=Math.abs(p[0]-H);n<r;n++)(o=Math.abs(p[n]-H))<s&&(s=o,i=n);(a()&&v<i||c())&&O(v=i,e,t,!1)},wheelHandler:function(e){if(!0===T)return!0;if(z.standardScrollElements&&(r(e.target).is(z.standardScrollElements)||r(e.target).closest(z.standardScrollElements).length))return!0;y[v]||e.preventDefault();var t=(new Date).getTime(),o=(e=e||i.event).originalEvent.wheelDelta||-e.originalEvent.deltaY||-e.originalEvent.detail,n=Math.max(-1,Math.min(1,o));if(149<D.length&&D.shift(),D.push(Math.abs(o)),200<t-I&&(D=[]),I=t,M)return!1;if(n<0){if(v<p.length-1&&a()){if(!R(D))return!1;e.preventDefault(),O(++v,!(M=!0),!0,!1)}}else if(0<n&&0<v&&c()){if(!R(D))return!1;e.preventDefault(),O(--v,!(M=!0),!0,!1)}},keyHandler:function(e){return!0===T||!0!==M&&void(38==e.keyCode||33==e.keyCode?0<v&&c()&&(e.preventDefault(),O(--v,!1,!0,!1)):40!=e.keyCode&&34!=e.keyCode||v<p.length-1&&a()&&(e.preventDefault(),O(++v,!1,!0,!1)))},init:function(){z.scrollbars?(b.on("mousedown",h.handleMousedown),b.on("mouseup",h.handleMouseup),b.on("scroll",h.handleScroll)):r("body").css({overflow:"hidden"}),b.on(L,h.wheelHandler),b.on("keydown",h.keyHandler)}}),direction:"undetermined"},options:{distance:30,timeGap:800,timeStamp:(new Date).getTime()},touchHandler:function(e){if(!0===T)return!0;if(z.standardScrollElements&&(r(e.target).is(z.standardScrollElements)||r(e.target).closest(z.standardScrollElements).length))return!0;var t;if(void 0!==e&&void 0!==e.touches)switch(t=e.touches[0],e.type){case"touchstart":f.touches.touchstart.y=t.pageY,f.touches.touchmove.y=-1,f.touches.touchstart.x=t.pageX,f.touches.touchmove.x=-1,f.options.timeStamp=(new Date).getTime(),f.touches.touchend=!1;case"touchmove":f.touches.touchmove.y=t.pageY,f.touches.touchmove.x=t.pageX,f.touches.touchstart.y!==f.touches.touchmove.y&&Math.abs(f.touches.touchstart.y-f.touches.touchmove.y)>Math.abs(f.touches.touchstart.x-f.touches.touchmove.x)&&(e.preventDefault(),f.touches.direction="y",f.options.timeStamp+f.options.timeGap<(new Date).getTime()&&0==f.touches.touchend&&(f.touches.touchend=!0,-1<f.touches.touchstart.y&&Math.abs(f.touches.touchmove.y-f.touches.touchstart.y)>f.options.distance&&(f.touches.touchstart.y<f.touches.touchmove.y?f.up():f.down())));break;case"touchend":!1===f.touches[e.type]&&(f.touches[e.type]=!0,-1<f.touches.touchstart.y&&-1<f.touches.touchmove.y&&"y"===f.touches.direction&&(Math.abs(f.touches.touchmove.y-f.touches.touchstart.y)>f.options.distance&&(f.touches.touchstart.y<f.touches.touchmove.y?f.up():f.down()),f.touches.touchstart.y=-1,f.touches.touchstart.x=-1,f.touches.direction="undetermined"))}},down:function(){v<p.length-1&&(a()&&v<p.length-1?O(++v,!1,!0,!1):Math.floor(m[v].height()/b.height())>w?(t(parseInt(p[v])+b.height()*w),w+=1):t(parseInt(p[v])+(m[v].outerHeight()-b.height())))},up:function(){0<=v&&(c()&&0<v?O(--v,!1,!0,!1):2<w?(w-=1,t(parseInt(p[v])+b.height()*w)):(w=1,t(parseInt(p[v]))))},init:function(){s.addEventListener&&z.touchScroll&&(s.addEventListener("touchstart",f.touchHandler,!1),s.addEventListener("touchmove",f.touchHandler,!1),s.addEventListener("touchend",f.touchHandler,!1))}},d={refresh:function(e,t){clearTimeout(l),l=setTimeout(function(){o(!0),n(t,!1),e&&z.afterResize()},400)},handleUpdate:function(){d.refresh(!1,!1)},handleResize:function(){d.refresh(!0,!1)},handleOrientation:function(){d.refresh(!0,!0)}},z=r.extend(z,e),o(!1),n(!1,!0),!0===S?O(v,!1,!0,!0):setTimeout(function(){h.calculateNearest(!0,!1)},200),p.length&&(h.init(),f.init(),b.on("resize",d.handleResize),s.addEventListener&&i.addEventListener("orientationchange",d.handleOrientation,!1))};function o(e,t){for(var o=g.length;0<=o;o--)"string"==typeof e?g[o]===e&&O(v=o,t,!0,!0):o===e&&O(v=o,t,!0,!0)}return e.move=function(e){if(e===t)return!1;e.originalEvent&&(e=r(this).attr("href")),o(e,!1)},e.instantMove=function(e){if(e===t)return!1;o(e,!0)},e.next=function(){v<g.length&&O(v+=1,!1,!0,!0)},e.previous=function(){0<v&&O(v-=1,!1,!0,!0)},e.instantNext=function(){v<g.length&&O(v+=1,!0,!0,!0)},e.instantPrevious=function(){0<v&&O(v-=1,!0,!0,!0)},e.destroy=function(){if(!N)return!1;z.setHeights&&r(z.section).each(function(){r(this).css("height","auto")}),b.off("resize",d.handleResize),z.scrollbars&&(b.off("mousedown",h.handleMousedown),b.off("mouseup",h.handleMouseup),b.off("scroll",h.handleScroll)),b.off(L,h.wheelHandler),b.off("keydown",h.keyHandler),s.addEventListener&&z.touchScroll&&(s.removeEventListener("touchstart",f.touchHandler,!1),s.removeEventListener("touchmove",f.touchHandler,!1),s.removeEventListener("touchend",f.touchHandler,!1)),p=[],g=[],m=[],y=[]},e.update=function(){if(!N)return!1;d.handleUpdate()},e.current=function(){return m[v]},e.disable=function(){T=!0},e.enable=function(){T=!1,N&&h.calculateNearest(!1,!1)},e.isDisabled=function(){return T},e.setOptions=function(e){if(!N)return!1;"object"===_typeof(e)?(z=r.extend(z,e),d.handleUpdate()):i.console&&console.warn("Scrollify warning: setOptions expects an object.")},r.scrollify=e});
"use strict";var webRoot="https://cpxbpm.com";function getDomNode(e){return document.getElementById(e)}var nav=document.getElementById("nav"),open=document.getElementById("openNav"),close=document.getElementsByClassName("ui-nav-close")[0];function openNav(){nav.className="ui-nav active"}function closeNav(){nav.className="ui-nav"}open.onclick=function(){openNav()},close.onclick=function(){closeNav()},nav.onclick=function(){closeNav()};var message={body:document.body,__delay:3e3,success:function(e){var n=this,s=this.__delay,a='<a class="ui-message-body ui-message-success"><span class="ui-message-success-icon">√</span><span>'+(e||"")+"</span></a>",i=document.createElement("div");i.className="ui-message-box active",i.innerHTML=a,this.body.appendChild(i),i.onclick=function(){s=0,n.remove(i)},setTimeout(function(){0!=s&&n.remove(i)},this.__delay)},info:function(e){var n=this,s=this.__delay,a='<a class="ui-message-body ui-message-info"><span class="ui-message-info-icon">i</span><span>'+(e||"")+"</span></a>",i=document.createElement("div");i.className="ui-message-box active",i.innerHTML=a,this.body.appendChild(i),i.onclick=function(){s=0,n.remove(i)},setTimeout(function(){0!=s&&n.remove(i)},this.__delay)},warning:function(e){var n=this,s=this.__delay,a='<a class="ui-message-body ui-message-warning"><span class="ui-message-warning-icon">!</span><span>'+(e||"")+"</span></a>",i=document.createElement("div");i.className="ui-message-box active",i.innerHTML=a,this.body.appendChild(i),i.onclick=function(){s=0,n.remove(i)},setTimeout(function(){0!=s&&n.remove(i)},this.__delay)},error:function(e){var n=this,s=this.__delay,a='<a class="ui-message-body ui-message-error"><span class="ui-message-error-icon">×</span><span>'+(e||"")+"</span></a>",i=document.createElement("div");i.className="ui-message-box active",i.innerHTML=a,this.body.appendChild(i),i.onclick=function(){s=0,n.remove(i)},setTimeout(function(){0!=s&&n.remove(i)},this.__delay)},remove:function(e){var n=this;e.className="ui-message-box",setTimeout(function(){n.body.removeChild(e)},100)}};function joinUsPageTab(e){window.location.href=["environment.html","companyCulture.html","jobs.html"][e]}
"use strict";function setLogoType(a){var e=document.getElementById("logo"),n=document.getElementById("contact"),s=document.getElementById("openNav"),t={className:"ui-logo",panels:["home1","home2","home3","joinUs"]},c={className:"ui-logo-black",panels:["pre","clawin1","clawin2","clawin3","business","payment","contactUs"]};-1!=t.panels.indexOf(a)&&(e.className=t.className,s.className="navWhiteIcon",n.className="contactWhite"),-1!=c.panels.indexOf(a)&&(e.className=c.className,s.className="navBlackIcon",n.className="contactBlack")}$(function(){var c=["home1","home2","home3","pre","clawin1","clawin2","clawin3","business","payment","joinUs","contactUs"];function a(){$.scrollify.current()}$("."+c[0]).css("display","block"),$("."+c[0]).addClass("active"),setTimeout(function(){$("."+c[0]+" .animateBorder").css("display","none")},720),$.scrollify({section:".panel",scrollbars:!1,before:function(a,e){var n=e[a].attr("data-section-name");for(a=0;a<c.length;a++){var s=c[a],t=s==n?"block":"none";$("."+s).css("display",t),$("."+s+" .animateBorder").css("display",t)}$("."+n).addClass("active"),$(".pagination a.active").removeClass("active"),$(".pagination a[href=#"+n+"]").addClass("active"),setLogoType(n)},after:function(a,e){var n=e[a].attr("data-section-name");$("."+n).removeClass("active"),$("."+n+" .animateBorder").css("display","none")},afterResize:a,afterRender:a}),$(".pagination a,#contact a,.ui-nav-content a,.guide").on("click",function(){$.scrollify.move($(this).attr("href"))})});
"use strict";var currentDeg,getEle=document.getElementsByClassName.bind(document),pointer=getEle("pointer")[0],zp=getEle("lotteryContent")[0],lights=Array.prototype.slice.call(getEle("light")),onRotation=!1,reward=["thanks","10 gold","thanks","30 gold","thanks","50 gold"],getReward=(currentDeg=0,function(){var t=360*Math.random()+1080;currentDeg+=t;var e=reward[Math.floor((currentDeg+18)%360/36)];return{deg:currentDeg,text:"thanks"===e?"I`m so sorry":e}}),lotteryEventStart=function(){if(zp.className="lotteryContent active",!onRotation){onRotation=!0,lights.forEach(function(t){t.className+=" light-twinkling"});var t=getReward();pointer.style.transform="rotateZ("+t.deg+"deg)"}},lotteryEventEnd=function(){zp.className="lotteryContent",setTimeout(function(){onRotation=!1,lights.forEach(function(t){t.className="light"})},300)};zp.addEventListener("click",function(){lotteryEventStart()}),pointer.addEventListener("click",function(){lotteryEventStart()}),zp.addEventListener("transitionend",function(){lotteryEventEnd()}),pointer.addEventListener("transitionend",function(){lotteryEventEnd()});
"use strict";var friendsConfig=[{title:"Pokonyan",desc:"Plush dolls <br/> 20-25CM",imgPath:"./assets/images/clawin/friends1.png"},{title:"Panda from China",desc:"Plush dolls <br/> 20-25CM",imgPath:"./assets/images/clawin/friends2.png"},{title:"Husky Dog",desc:"Plush dolls <br/> 22CM",imgPath:"./assets/images/clawin/friends3.png"},{title:"Tibbers",desc:"Cosplay plush dolls <br/> 30CM",imgPath:"./assets/images/clawin/friends4.png"},{title:"Espeon",desc:"plush dolls <br/> 20-22CM",imgPath:"./assets/images/clawin/friends5.png"},{title:"Togepi",desc:"Plush dolls <br/> 22CM",imgPath:"./assets/images/clawin/friends6.png"}],current=0,interval=null;function renderFriendsBox(n){if(n){var e=document.getElementById("friendsBox");e.innerHTML="";var s='<div class="friendsText">\n                    <h3>'+n.title+"</h3>\n                    <p>"+n.desc+'</p>\n               </div>\n               <div class="friendsImgs friendsImgOne">\n                   <img src="'+n.imgPath+'">\n               </div>';e.innerHTML=s}}function changeFriends(n){"prev"==n&&-1==--current&&(current=friendsConfig.length-1),"next"==n&&++current==friendsConfig.length&&(current=0),renderFriendsBox(friendsConfig[current])}window.onload=function(){renderFriendsBox(friendsConfig[current]),interval=setInterval(function(){changeFriends("next")},3e3)};